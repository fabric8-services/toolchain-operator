...
import (
	...
	codereadyv1alpha1 "github.com/dipak-pawar/toolchain-enabler/pkg/apis/codeready/v1alpha1"
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileToolChainEnabler{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner ToolChainEnabler
...
func newPodForCR(cr *codereadyv1alpha1.ToolChainEnabler) *corev1.Pod {
